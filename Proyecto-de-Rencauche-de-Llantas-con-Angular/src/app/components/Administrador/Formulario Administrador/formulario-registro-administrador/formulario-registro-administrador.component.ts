...
@Component({
  selector: 'app-formulario-registro-administrador',
  templateUrl: './formulario-registro-administrador.component.html',
  styleUrls: ['./formulario-registro-administrador.component.css']
})
export class FormularioRegistroAdministradorComponent implements OnInit {
